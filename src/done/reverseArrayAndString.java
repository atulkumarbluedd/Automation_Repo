...
public class reverseArrayAndString {
	...
	public void reverseWordInMyString(String str) {
		...
		System.out.println(reversedString+" *****reverse word inplace***");
	}
	...
	public static void main(String[] args) {
		...
		System.out.println(reversed+"----swap the positions and remain the words as it is-----");
		...
		for (String v : n1) {
		 ...
		 System.out.println(reverse+ " reverse words in place logic 2");
