...
public class findWeightedAverageOfGroupOfTrades {
    public static void main(String[] args) throws IOException {

        String jsonData = Files.readString(Paths.get(System.getProperty("user.dir") + "/src/test/java/resources/TradeGroups.json"));
...
//                + "/src/test/resources/trades.json"));
        ...
        Map<String,List<Trade>> groupedTrades=
                gson.fromJson(jsonData,new TypeToken<Map<String,List<Trade>>>(){}.getType());
     ...
     // ****************** for jakson mapper ******************
        ...
        // do on your own, it is same as above Gson code just change the mapper to ObjectMapper and use TypeReference.
