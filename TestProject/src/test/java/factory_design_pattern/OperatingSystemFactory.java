 ...
 * @return
 */
	public static OperatingSystem getInstance(String type, String version, String achitecture) {
		 
		switch (type){
        case "WINDOWS":
            return new WindowsOperatingSystem(version,achitecture);
        case "LINUX":
            return new LinuxOperatingSystem(version,achitecture);
        default:
